...
if (/is-matchday/.test(read('src/LiveDashboard.tsx')) && /Matchday · TSU Ainet/.test(read('src/LiveDashboard.tsx'))) pass('Matchday-Hero ist eingebaut.'); else fail('Matchday-Hero fehlt.');
