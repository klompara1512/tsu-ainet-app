...
const items: Array<{page:string; label:string; icon:IconName}> = [
  {page:"start",label:"Start",icon:"home"},{page:"kalender",label:"Spiele",icon:"calendar"},{page:"teams",label:"Teams",icon:"teams"},{page:"news",label:"News",icon:"news"},{page:"mehr",label:"Mehr",icon:"more"}
];
